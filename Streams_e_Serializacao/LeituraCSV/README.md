...
ele utiliza a seguinte linha para recuprar as informações de clientes: LinkedList<Cliente> clientes = leitorCsv.leCsvClientes(); // cria a lista de clientes. A soma total deve ser 25.000
